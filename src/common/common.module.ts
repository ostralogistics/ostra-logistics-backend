...
@Module({
    imports:[TypeOrmModule.forFeature([OrderEntity,Notifications,NewsLetterEntity])],
    providers:[websocketgw,DistanceService,UploadService,Mailer,GeoCodingService,GeneatorService,JwtService,PublicService],
